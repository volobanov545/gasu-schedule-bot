...
The selected deployment is now GitHub Actions, not a VPS or an always-on home computer.
The scheduled workflow runs at 20:30 Moscow time, fetches tomorrow's schedule, sends one
static card, and exits. Setup instructions are in
